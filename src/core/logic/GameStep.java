...
import static core.logic.enums.CellStatus.MINE_PLACED;
import static core.logic.enums.CellStatus.QUIT_MATCH;
...
public class GameStep {
    ...
    GameStep(CellStatus cellStatus, int row, int col, Player player, Player opponent) {
    ...
    ReplayInfo getReplayInfo() {
        return new ReplayInfo(personalBoard, traceBoard, toString());
    }
